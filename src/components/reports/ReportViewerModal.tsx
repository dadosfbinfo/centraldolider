    ...
    >
      ...
      >
        ...
        <div
          ...
          className="flex-1 overflow-y-auto p-4 sm:p-8 bg-stone-950/80 flex justify-center"
        >
        ...
        {/* Footer Bar with "Confirmo que li este relatório" Checkbox */}
        <div
        ...
        >
          {currentUser && currentUser.role === 'LIDER' ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="text-xs text-stone-400 block">
                      {isConfirmed
                        ? `Leitura registrada por ${userConfirmation?.usuario_nome || currentUser.nome} em ${formattedConfirmDate(userConfirmation?.data_hora || new Date().toISOString())}`
